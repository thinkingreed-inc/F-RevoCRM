...
$languageStrings = array(
	...
	'LBL_TRANSFER_OWNERSHIP_DESC' => 'You can transfer the "%2$s" privilege, currently held by "%1$s", to another user with administrator privileges.',
	...
	'LBL_CHOOSE_ANOTHER_MFA_METHOD' => 'Choose another authentication method',
	...
	'LBL_TOTP_CODE_INCORRECT' => 'Incorrect one-time password. Please try again.',
	'LBL_PASSKEY_CODE_INCORRECT' => 'Passkey authentication failed. Please try again.',
	'LBL_TOTP_CODE_SUBMIT' => 'Submit one-time password',
...
If you specify a full-width number, a string that cannot be recognized as a number, or a value less than or equal to 0, the login lock will not be activated.',
	...
	'LBL_TOTP_DESCRIPTION' => 'A standard authentication method that uses a 6-digit number (one-time password) generated by an authentication app.',
