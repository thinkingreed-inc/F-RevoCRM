					...
					<div class="quickCreateContent calendarQuickCreateContent" style="padding-top:2%;margin-top:5px;">
						...
						<div class="row" style="padding-top: 2%;">
							<div class="col-sm-12">
								...
								<div class="muted col-sm-2" style="line-height: 67px;left: 20px; padding-right: 7%;">
						...
						<div class="container-fluid paddingTop15 quickCreateContent">
										...
										{if $isReferenceField neq "reference"}<label class="muted">{/if}
											{if $isReferenceField eq "reference"}
												{if $referenceListCount > 1}
													...
													{/if}
													<span class="">
														<select style="width: 150px;" class="select2 referenceModulesList" {if !empty($REFERENCED_MODULE_NAME)} disabled {/if}>
