			...
			<div class="row contentHeader extension_header" style="margin-bottom: 10px;">
				<div class="col-sm-6 col-xs-6" style="margin-bottom: 5px;">
					<div style="margin-bottom: 5px;">
						...
						<span class="muted">{vtranslate('LBL_BY', $QUALIFIED_MODULE)}&nbsp;{$AUTHOR_INFO['lastname']}&nbsp;{$AUTHOR_INFO['firstname']}</span>
					</div>
							...
							<div class="scrollableTab">
								<div class="row extension_header">
									<div class="col-sm-6 col-xs-6">
										...
										{else}
											<div class="font-x-x-large authorInfo">{$AUTHOR_INFO['lastname']}&nbsp;{$AUTHOR_INFO['firstname']}</div>
										{/if}
