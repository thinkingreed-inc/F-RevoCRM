...
{strip}
    ...
    <div name='editContent'>
        <div class='fieldBlockContainer'>
            <span>
                <h4 class='fieldBlockHeader' >{vtranslate('SINGLE_PDFTemplates', $MODULE)}</h4>
            </span>
            <hr>
        ...
        <div class='fieldBlockContainer'>
            <span>
                <h4 class='fieldBlockHeader'>{vtranslate('LBL_PDF_TEMPLATE', $MODULE)} {vtranslate('LBL_DESCRIPTION', $MODULE)}</h4>
            </span>
            <hr>
            <table class="table table-borderless">
                <tbody>
                                ...
                                <select class="inputElement select2 col-sm5 col-xs-5" id="generalFields" name="generalFields">
                                    ...
                                    <optgroup label="{vtranslate('LBL_GENERAL_FIELDS', $MODULE)}">
                                        {foreach key=index item=GENERAL_FIELD from=$GENERAL_FIELDS}
                                            <option value="{$GENERAL_FIELD[1]}">{vtranslate($GENERAL_FIELD[0], $MODULE)}</option>
                                        {/foreach}
                                    </optgroup>
                                </select>
                            </span>
