...
<table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
	<tbody>
		<tr>
			<td style="text-align: center;"><strong style="font-size: 20px; text-align: center;">{vtranslate("LBL_ORDER_CONFIRMATION","PDFTemplates")}</strong></td>
		</tr>
		<tr>
...
<table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
	<tbody>
		<tr>
			<td style="width: 350px;">$salesorder-accountid:accountname$ {vtranslate("LBL_FOR_THE_ATTENTION_OF","PDFTemplates")}<br />
			<br />
			<span style="font-size:9px;">{vtranslate("LBL_THANK_YOU_FOR_YOUR_ORDER","PDFTemplates")}</span><br />
			<br />
			&nbsp;
			<table border="0" cellpadding="0" cellspacing="0" style="width:250px;">
				<tbody>
					<tr>
						<td><span style="font-size:11px;">{vtranslate("LBL_QUOTATION_NO","PDFTemplates")}</span></td>
						<td></td>
