...
{strip}
    ...
    <form id="detailView" data-name-fields='{ZEND_JSON::encode($NAME_FIELDS)}' method="POST">
        ...
        {include file='DetailViewUserCredentialBlockView.tpl'|@vtemplate_path:$MODULE_NAME RECORD_STRUCTURE=$RECORD_STRUCTURE MODULE_NAME=$MODULE_NAME USER_MULTI_FACTOR_CREDENTIAL_LIST=$USER_MULTI_FACTOR_CREDENTIAL_LIST RECODEID=$RECODEID}
    </form>
