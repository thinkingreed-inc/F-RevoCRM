                        ...
                        {if $type == 'passkey'}
                            <div class="group">
                                <form id="passkeyForm" action="index.php" method="post">
                                    ...
                                    <button id="passkeyLoginBtn" class="d-flex justify-content-center button buttonBlue" type="button">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            var challengeBytes = base64ToUint8Array(challenge);
                            $('input[name="challenge"]').val(challengeBytes);

                                if (!navigator.credentials || !navigator.credentials.create) {
                                console.error('{vtranslate('LBL_WEBAUTHN_ERROR','Users')}');
                                return;
                            }
                            try {
                                navigator.credentials.get({
                                    ...
                                    alert('{vtranslate('LBL_WEBAUTHN_ERROR','Users')}');
                                });
                            } catch (error) {
                                console.error('WebAuthn Error:', error);
                                alert('{vtranslate('LBL_WEBAUTHN_ERROR','Users')}');
