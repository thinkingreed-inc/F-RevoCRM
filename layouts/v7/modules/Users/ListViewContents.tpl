										...
										<span class="fieldValue">
											<span class="value textOverflowEllipsis">
												<div style="margin-left: -13px;">
													...
													{/if}
													<div class="usersinfo col-lg-9 textOverflowEllipsis" title="{$LISTVIEW_ENTRY->get('last_name')} {$LISTVIEW_ENTRY->get('first_name')}">
														<a href="{$LISTVIEW_ENTRY->getDetailViewUrl()}">{$LISTVIEW_ENTRY->get('last_name')} {$LISTVIEW_ENTRY->get('first_name')}</a>
													</div>
