        ...
        <script>
            function checkPassword() {
                ...
                if (password == '' && confirmPassword == '') {
                    ...
                    return false;
               } else if (!app.helper.checkStrengthPassword(password)) {
...
<div id="js_strings" class="hide noprint"style="display:none;">{Zend_Json::encode($LANGUAGE_STRINGS)}</div>
<script src="{$SITE_URL}layouts/v7/resources/app.js"></script>
</body>
</html>
