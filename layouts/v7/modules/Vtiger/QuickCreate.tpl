                    ...
                    <div class="quickCreateContent">
                        <table class="massEditTable table no-border">
                            <tr>
                                ...
                                {foreach key=BLOCK_NAME item=FIELDS from=$RECORD_STRUCTURE}
                                    {foreach key=FIELD_NAME item=FIELD_MODEL from=$FIELDS}
                                        ...
                                        {assign var="isQuickCreateEnabled" value=$FIELD_MODEL->isQuickCreateEnabled()}
                                        {if $isQuickCreateEnabled != true}
                                            <input type="hidden" name="{$FIELD_NAME}" value="{$FIELD_MODEL->get('fieldvalue')}">
                                            {continue}
                                        {/if}
