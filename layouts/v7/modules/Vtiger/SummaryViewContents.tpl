			...
			<tr class="summaryViewEntries">
				...
				<td class="fieldValue">
                    <div class="">
                        ...
                        <span class="value textOverflowEllipsis" title="{strip_tags($DISPLAY_VALUE)}"  {if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '21'}style="word-wrap: break-word;"{/if}>
