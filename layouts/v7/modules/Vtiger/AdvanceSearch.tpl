                                            ...
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    {if $SAVE_FILTER_PERMITTED}
                                                        <button class="btn btn-success col-lg-2 marginLeft10px"  id="advanceIntiateSave"><strong>{vtranslate('LBL_SAVE_AS_FILTER', $MODULE)}</strong></button>
                                                        <input class="hide col-lg-3 marginLeft10px" type="text" value="" name="viewname"/>
                                                        <button class="btn btn-success hide col-lg-2 marginLeft10px"  id="advanceSave"><strong>{vtranslate('LBL_SAVE', $MODULE)}</strong></button>
                                                    {/if}
                                                </div>
                                            </div>
                                        </div>
