...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return app.vtranslate("LBL_NO_MATCHES_FOUND"); },
        formatInputTooShort: function (input, min) { var n = min - input.length; return n + app.vtranslate("LBL_PLEASE_ENTER_MORE"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Please delete " + n + " character" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "You can only select " + limit + " item" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "Loading more results…"; },
        formatSearching: function () { return app.vtranslate("LBL_LOADING"); },
