...
class Settings_HolidayManager_EditAjax_View extends Settings_Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$recordModel = Settings_HolidayManager_Record_Model::getInstanceById($recordId);
