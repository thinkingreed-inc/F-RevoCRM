...
class Settings_Workflows_Field_Model extends Vtiger_Field_Model {
	...
	public static function getAdvancedFilterOpsByFieldType() {
		return array(
			...
			'datetime' => array('is', 'is not', 'has changed', 'before', 'after', 'is today', 'is tomorrow', 'is yesterday', 'days ago', 'days later', 'less than hours before', 'less than hours later',
				'less than days ago', 'less than days later', 'more than days ago', 'more than days later'),
