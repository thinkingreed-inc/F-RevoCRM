...
$reports = Array(Array('reportname'=>vtranslate('Contacts by Accounts'),
                       'reportfolder'=>vtranslate('Account and Contact Reports'),
                       'description'=>vtranslate('Contacts related to Accounts'),
                       'reporttype'=>'tabular',
		       'sortid'=>'','stdfilterid'=>'','advfilterid'=>'0'),

		 Array('reportname'=>vtranslate('Contacts without Accounts'),
                       'reportfolder'=>vtranslate('Account and Contact Reports'),
                       'description'=>vtranslate('Contacts not related to Accounts'),
                       'reporttype'=>'tabular',
		       'sortid'=>'','stdfilterid'=>'','advfilterid'=>'1'),

		 Array('reportname'=>vtranslate('Contacts by Potentials'),
                       'reportfolder'=>vtranslate('Account and Contact Reports'),
                       'description'=>vtranslate('Contacts related to Potentials'),
                       'reporttype'=>'tabular',
		       'sortid'=>'','stdfilterid'=>'','advfilterid'=>'2'),

		 Array('reportname'=>vtranslate('Lead by Source'),
                       'reportfolder'=>vtranslate('Lead Reports'),
                       'description'=>vtranslate('Lead by Source'),
                       'reporttype'=>'summary',
		       'sortid'=>'0','stdfilterid'=>'','advfilterid'=>''),

		 Array('reportname'=>vtranslate('Lead Status Report'),
                       'reportfolder'=>vtranslate('Lead Reports'),
                       'description'=>vtranslate('Lead Status Report'),
                       'reporttype'=>'summary',
                       'sortid'=>'1','stdfilterid'=>'','advfilterid'=>''),

		 Array('reportname'=>vtranslate('Potential Pipeline'),
                       'reportfolder'=>vtranslate('Potential Reports'),
                       'description'=>vtranslate('Potential Pipeline'),
                       'reporttype'=>'summary',
                       'sortid'=>'2','stdfilterid'=>'','advfilterid'=>''),

		 Array('reportname'=>vtranslate('Closed Potentials'),
                       'reportfolder'=>vtranslate('Potential Reports'),
                       'description'=>vtranslate('Potential that have Won'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'','advfilterid'=>'3'),

		 Array('reportname'=>vtranslate('Last Month Activities'),
                       'reportfolder'=>vtranslate('Activity Reports'),
                       'description'=>vtranslate('Last Month Activities'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'0','advfilterid'=>''),

		 Array('reportname'=>vtranslate('This Month Activities'),
                       'reportfolder'=>vtranslate('Activity Reports'),
                       'description'=>vtranslate('This Month Activities'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'1','advfilterid'=>''),

		 Array('reportname'=>vtranslate('Tickets by Products'),
                       'reportfolder'=>vtranslate('HelpDesk Reports'),
                       'description'=>vtranslate('Tickets related to Products'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'','advfilterid'=>''),

		 Array('reportname'=>vtranslate('Tickets by Priority'),
                       'reportfolder'=>vtranslate('HelpDesk Reports'),
                       'description'=>vtranslate('Tickets by Priority'),
                       'reporttype'=>'summary',
                       'sortid'=>'3','stdfilterid'=>'','advfilterid'=>''),

 		 Array('reportname'=>vtranslate('Open Tickets'),
                       'reportfolder'=>vtranslate('HelpDesk Reports'),
                       'description'=>vtranslate('Open Tickets'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'','advfilterid'=>'4'),

		 Array('reportname'=>vtranslate('Product Details'),
                       'reportfolder'=>vtranslate('Product Reports'),
                       'description'=>vtranslate('Product Detailed Report'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'','advfilterid'=>''),

		 Array('reportname'=>vtranslate('Products by Contacts'),
                       'reportfolder'=>vtranslate('Product Reports'),
                       'description'=>vtranslate('Products related to Contacts'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'','advfilterid'=>''),
		 ...
		 Array('reportname'=>vtranslate('Quotes Detailed Report'),
                       'reportfolder'=>vtranslate('Quote Reports'),
                       'description'=>vtranslate('Quotes Detailed Report'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'','advfilterid'=>''),

		 Array('reportname'=>vtranslate('PurchaseOrder by Contacts'),
                       'reportfolder'=>vtranslate('PurchaseOrder Reports'),
                       'description'=>vtranslate('PurchaseOrder related to Contacts'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'','advfilterid'=>''),

		 Array('reportname'=>vtranslate('PurchaseOrder Detailed Report'),
                       'reportfolder'=>vtranslate('PurchaseOrder Reports'),
                       'description'=>vtranslate('PurchaseOrder Detailed Report'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'','advfilterid'=>''),

		 Array('reportname'=>vtranslate('Invoice Detailed Report'),
                       'reportfolder'=>vtranslate('Invoice Reports'),
                       'description'=>vtranslate('Invoice Detailed Report'),
                       'reporttype'=>'tabular',
		       'sortid'=>'','stdfilterid'=>'','advfilterid'=>''),

		 Array('reportname'=>vtranslate('SalesOrder Detailed Report'),
                       'reportfolder'=>vtranslate('PurchaseOrder Detailed Report'),
                       'description'=>vtranslate('SalesOrder Detailed Report'),
                       'reporttype'=>'tabular',
                       'sortid'=>'','stdfilterid'=>'','advfilterid'=>''),

	         Array('reportname'=>vtranslate('Campaign Expectations and Actuals'),
		       'reportfolder'=>vtranslate('Campaign Reports'),
		       'description'=>vtranslate('Campaign Expectations and Actuals'),
		       'reporttype'=>'tabular',
		       'sortid'=>'','stdfilterid'=>'','advfilterid'=>'')
