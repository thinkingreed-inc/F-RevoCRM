							...
							<tbody>
								<tr>
									<td>
										...
										{vtranslate('LBL_NO')} {vtranslate($MODULE, $MODULE)} {vtranslate('LBL_FOUND')}. {vtranslate('LBL_CREATE')}<a class="rssAddButton" href="#" data-href="{$QUICK_LINKS['SIDEBARLINK'][0]->getUrl()}"></a>
									</td>
								</tr>
							</tbody>
						</table>
