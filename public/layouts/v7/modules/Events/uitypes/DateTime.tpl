...
<div class="">
	<label>
		<span class='input-group-addon' style="border:1px solid #d9d9d9;width:auto;">{vtranslate("LBL_ALL_DAY", $MODULE_NAME)}
			<input id='alldayEvent' type='checkbox' name='is_allday' class="" onclick="Calendar_Edit_Js.changeAllDay();" {if $IS_ALLDAY == true}checked{/if}/>
		</span>
	</label>
</div>
{/if}