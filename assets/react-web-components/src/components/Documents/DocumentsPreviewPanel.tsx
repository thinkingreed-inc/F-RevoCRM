...
function getLocationLabel(t: (key: string) => string, type: string): string {
  switch (type) {
    case "I":
      return t("LBL_LOCATION_INTERNAL");
    case "E":
      return t("LBL_LOCATION_EXTERNAL");
    case "W":
      return "Web";
    default:
      return type;
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: isMobile ? 12 : 16 }}>
        ...
        <div style={{ borderTop: "1px solid #EDF2F7", paddingTop: 12 }}>
          ...
          <InfoRow
            ...
            value={getLocationLabel(t, doc.filelocationtype)}
          />
          {doc.filedownloadcount > 0 && (
            <InfoRow
              label={t("Download Count")}
              value={t("LBL_DOWNLOAD_COUNT_SUFFIX", doc.filedownloadcount)}
            />
          )}
        </div>
