...
describe("ProductTaxField", () => {
  ...
  describe("初期表示", () => {
    ...
    it("disabledの場合チェックボックスと入力が無効化される", () => {
      render(
        <ProductTaxField {...defaultProps} value="10.000" disabled={true} />,
      );
  ...
  describe("チェックボックス操作", () => {
    it("チェックONでデフォルト税率が設定される", () => {
      ...
      render(
        <ProductTaxField {...defaultProps} value="" onChange={onChange} />,
      );
  ...
  describe("エラー表示", () => {
    it("エラー時に入力フィールドにエラースタイルが適用される", () => {
      render(
        <ProductTaxField {...defaultProps} value="10.000" error="エラー" />,
      );
